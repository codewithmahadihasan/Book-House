...
const Modal2 = ({ handaleDelete, user }) => {
  console.log(user);
  return (
    <div>
      ...
      <div className="modal">
        <div className="modal-box relative">
          ...
          <p className="flex-1 mt-4 text-gray-400">
            If you delete this buyer once then he will be completely deleted
            from the database.
          </p>
