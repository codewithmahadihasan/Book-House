          ...
          <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
            ...
            <div className="max-w-xl mb-6">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
                <span className="inline-block text-purple-400 uppercase mr-4">
                  {user.displayName}
                </span>
                Wellcome
                <br />
                Book House Dashboard
              </h2>
              <p className="text-base text-gray-700 md:text-lg">
                Hello sir we are grateful to you. Thank you for giving us your
                valuable time.
              </p>
            </div>
            <div>
          ...
          <div className="flex items-center justify-center -mx-4 lg:pl-8">
            ...
            <div className="px-3">
              <img
                ...
                src="https://images.pexels.com/photos/2014695/pexels-photo-2014695.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt=""
              />
            </div>
          </div>
