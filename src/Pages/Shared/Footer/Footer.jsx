    ...
    <div className="bg-gray-200">
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="grid grid-cols-2 text-center  gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            <div>
              <Link
                to="/"
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t sm:flex-row">
          <p className="text-sm text-gray-600">
            © Copyright 2024 Mahadi Hasan. All rights reserved.
          </p>
          <div className="flex items-center  justify-center mt-4 space-x-4 sm:mt-0">
            <a
              href="https://twitter.com/codewithmahadi"
